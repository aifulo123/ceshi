...
#作业
    ...
    (r'^api/get_host_property/$', 'get_host_property'),
    (r'^api/set_host_monitor/$', 'set_host_monitor'),
    (r'^api/get_host_line_data/$', 'get_host_line_data'),
#二次模拟
    (r'^next/$', 'next'),
    (r'^haha/$', 'haha'),
    (r'^api/get_host_list_not_set/$', 'get_host_list_not_set'),
